...
# vista PDF Recibo Factura


class ReciboFactutaPdfView(View):
    ...
    def get(self, request, *args, **kwargs):
        try:
            template = get_template('SGCapp/recibos_facturas/invoice.html')
            context = {
                'recibo': Recibo.objects.get(pk=self.kwargs['pk']),
                'comp': {'name:': 'DevHoy', 'CUIT': '3099999990', 'address': 'Rosario, Santa Fe, Argentina'},
                'icon': '{}{}'.format(settings.STATIC_URL, 'img/Devhoy_logo.png')
            }
            ...
            pass
        return HttpResponseRedirect(reverse_lazy('SGCapp:ReciboFacturaListView'))
